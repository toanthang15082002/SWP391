 ...
 * @author ADMIN
 */
@WebServlet(name = "ListSessionServletController", urlPatterns = {"/listsession"})
public class ListSessionServletController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ListSessionServletController</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ListSessionServletController at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        SessionDAO sDao = new SessionDAO();
        String indexPage_raw = request.getParameter("indexPage");
        List<Session> selist = sDao.getSessionBySyllabusID(Integer.parseInt(sbysyllabusid_raw));
        int numPerPage = 10;
        int size = selist.size();
        int page = 1;
