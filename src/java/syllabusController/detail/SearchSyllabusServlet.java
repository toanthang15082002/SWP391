 ...
 * @author admin
 */
@WebServlet(name="SearchSyllabusServlet", urlPatterns={"/searchsyllabus"})
public class SearchSyllabusServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet SearchSyllabusServlet</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet SearchSyllabusServlet at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    } 
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            Account a = (Account) session.getAttribute("account");
                ...
                List<Syllabus> list = syd.searchPagingSyllabus(searchSyllabus,index, num, a.getAccountID());
