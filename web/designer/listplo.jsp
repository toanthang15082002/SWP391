                ...
                <div class="row">
                    ...
                    <div class="content__detail col-lg-10" >
                        <div class="content__detail-addSyllabus">
                            ...
                            <form action="searchplo" method="post">
                                <div class="d-flex justify-content-center" >
                                    <div class="form-outline col-lg-8">
                                        <input type="search" class="form-control" name="ploText" placeholder="Enter PLO name" style="height: 100%"/>
                                    </div>
                                    <button type="submit" class="btn btn-primary col-lg-2" >
                                        <i class="fa fa-search"></i>
                                    </button>
                                    <button style="margin-left: 5px" class="btn btn-primary" type="button">
                                        <a style="color: white" href="addplo">Add PLO</a>
                                    </button>
                                </div>
                            </form><br>

                            <form action="manageplo" method="post">
                                <div class="form-text">
                            ...
                            <c:if test="${requestScope.listPlo.size() == 0}">
                        ...
                        <c:if test="${requestScope.listPlo.size() > 0}">
                            <table class="table table-striped" style="font-size: 1.2em">
                                ...
                                <tbody>
                                    <c:forEach items="${listPlo}" var="o">
                                        <tr>
                                            <td>${o.ploid}</td>
                                            <td>${o.ploName}</td>
                                            <td>${o.ploDescription}</td>
                                            <td>
                                                <a style="font-size: 0.5em" href="./editplo?ploid=${o.ploid}&curid=${o.curid}"><i class="btn btn-square bi bi-pencil-square"></i></a>
                                                <a style="font-size: 0.5em" href="./deleteplo?ploid=${o.ploid}" onclick="return confirm('Are you sure you want to DELETE?');"><i class="btn btn-square bi bi-trash"></i></a>
                                            </td>
                                        </tr>
                                    </c:forEach>
                                </tbody>
                        ...
                        <nav aria-label="Page navigation example">
                            <ul class="pagination">
                                <c:if test="${tag > 1}">
                                    <li class="page-item">
                                        <a class="page-link" href="manageplo?page=${tag-1}" aria-label="Previous">
                                ...
                                <c:forEach begin="1" end="${endPage}" var="i">
                                    <li class="page-item ${tag == i ? "active" : ""}"><a class="page-link" href="manageplo?page=${i}">${i}</a></li>
                                    </c:forEach>
                                    <c:if test="${tag != endPage}"> 
                                    <li class="page-item">
                                        <a class="page-link" href="manageplo?page=${tag+1}" aria-label="Next">
