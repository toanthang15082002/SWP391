                ...
                <div class="row">
                    ...
                    <div class="content__detail col-lg-10" id="syllabusAddNew">
                        <div class="content__detail-addSyllabus">
                            ...
                            <h2>Add PLO</h2>
                            <br>
                            <form action="addplo" method="post">
                                <div class="syllabus__content form-group">
                                    <h3>PLO Name<small style="color: red"> *</small></h3>
                                    <input class="form-control" type="text" name="ploName" required="">
                                </div>
                                <br>
                                <div class="syllabus__content form-group">
                                    <h3>PLO Description<small style="color: red"> *</small></h3>
                                    <input class="form-control" type="text" name="ploDescription" required="">
                                </div>
                                <br>
                                <div class="syllabus__content form-group">
                                    <h3>Curriculum Code</h3>
                                    <select class="custom-select" id="inputGroupSelect01" name="curid">
                                            <!--<option selected value="">Choose...</option>-->
                                        <c:forEach items="${listCur}" var="o">
                                            <option value="${o.curid}">(${o.curCode}) ${o.curName}</option>
                                        </c:forEach>
                                    </select>
                                </div>
                                <br>
