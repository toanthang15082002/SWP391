                ...
                <div class="row">
                    ...
                    <div class="content__detail col-lg-10" >
                        <div class="content__detail-addSyllabus">
                            ...
                            <form action="listsyllabus" method="post">
                        ...
                        <div class="d-flex mt-3 mr-3" style="justify-content: end">
                                ...
                                <tbody>
                                    <c:forEach items="${requestScope.listsy}" var="sy">
                                        <tr>
                                            ...
                                            <td><input type="checkbox" <c:if test="${sy.isActive}">checked</c:if> disabled=""></td>
                                            <td><input type="checkbox"  <c:if test="${sy.isApproved}">checked</c:if>  disabled=""></td>
                                            <td>${sy.accountName}</td>
                                            <td><a href="decisiondetail?syllabusID=${sy.syllabusID}">${sy.decisionNo.decisionNo}</a></td>
                                            <td><a class="justify-content-center" href="editsyllabus?syllabusID=${sy.syllabusID}"><i class="fa-solid fa-pen-to-square"></i> </a></td>
                                        </tr>
                                    </c:forEach>
                                </tbody>
                            </table>
                        ...
                        <c:if test="${requestScope.listsy.size() >= num || tag == endPage}">
                            <nav aria-label="Page navigation example">
                                <ul class="pagination">
                                    <c:if test="${tag > 1}">
                                        <li class="page-item">
                                            <a class="page-link" href="listsyllabus?indexPage=${tag-1}" aria-label="Previous">
                                    ...
                                    <c:forEach begin="1" end="${endPage}" var="i">
                                        <li class="page-item ${tag == i?"active":""}"><a class="page-link" href="listsyllabus?indexPage=${i}">${i}</a></li>
                                        </c:forEach>
                                        <c:if test="${tag != endPage}"> 
                                        <li class="page-item">
                                            <a class="page-link" href="listsyllabus?indexPage=${tag+1}" aria-label="Next">
