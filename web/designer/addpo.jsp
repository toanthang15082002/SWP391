                        ...
                        <div class="content__detail-addSyllabus">
                            ...
                            <form action="addpo" method="post">
                                <div class="syllabus__content form-group">
                                    <h3>PO Name<small style="color: red"> *</small></h3>
                                    <input class="form-control" type="text" name="poName" required="">
                                </div>
                                <br>
                                <div class="syllabus__content form-group">
                                    <h3>PO Description<small style="color: red"> *</small></h3>
                                    <input class="form-control" type="text" name="poDescription" required="">
                                </div>
                                <br>
                                <div class="syllabus__content form-group">
