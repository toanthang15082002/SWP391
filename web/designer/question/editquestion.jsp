                ...
                <div class="row">
                    ...
                    <div class="content__detail col-lg-10" id="syllabusAddNew">
                        <div class="content__detail-addSyllabus">
                            ...
                            <h2>Edit Question</h2>
                        <c:set value="${requestScope.qlist}" var="ql"/>
                        <div class="modal-body">
                            <form action="editquestion" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" readonly required name="sid" value="${ql.sid}" id="recipient-name">
                                </div>
                                <div class="form-group">
                                    <label for="message-text" class="col-form-label"  >Question Name <span class="text-danger"> *</span></label>
                                    <input class="form-control" id="message-text" required name="questionname" value="${ql.nameQuestion}">
                                </div>
                                <div class="form-group">
