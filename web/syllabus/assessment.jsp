        ...
        <div class="container">
            ...
            <div>
                ...
                <div>
                            ...
                            <h4 class="mt-3 mb-3">${requestScope.asslist.size()} assessment(s)</h4>  
                            <div>
                                <table class="table table-striped table-bordered table-title" cellspacing="0" rules="all" border="1" id="gvAssessment" style="border-collapse:collapse;">
                                    <tbody><tr>
                                        ...
                                        <c:forEach items="${requestScope.asslist}" var="ass">
                                            <tr>
                                                <td>${ass.category}</td>
