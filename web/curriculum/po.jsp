        ...
        <header>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div>
                        <h4 class="mt-3 mb-3">5 PO(s)</h4>
                        <div>
                            <table class="table table-striped table-bordered table-title" cellspacing="0" rules="all" border="1" id="gvPO"
                                ...
                                <tbody>
                                <c:forEach items="${listPo}" var="o" varStatus="count">
                                    <tr>
                                        <td>${count.count}</td>
                                        <td>${o.poName}</td>
